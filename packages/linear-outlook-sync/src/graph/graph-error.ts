...
export class GraphEndpointNotFoundError extends Data.TaggedError(
  'GraphEndpointNotFoundError'
)<BaseErrorProps> {}

export class GraphPermissionError extends Data.TaggedError(
  'GraphPermissionError'
)<BaseErrorProps> {}

export class GraphUnauthorizedError extends Data.TaggedError(
  'GraphUnauthorizedError'
)<BaseErrorProps> {}

export class GraphRateLimitError extends Data.TaggedError(
  'GraphRateLimitError'
)<BaseErrorProps> {}

export class GraphBadRequestError extends Data.TaggedError(
  'GraphBadRequestError'
)<BaseErrorProps> {}

export class InvalidGraphResponseError extends Data.TaggedError(
  'InvalidGraphResponseError'
)<BaseErrorProps> {}
...
export class GraphGenericError extends Data.TaggedError(
  'GraphGenericError'
)<GenericErrorProps> {}
...
export const parseGraphResponseError = (
  endpoint: string,
